...
public enum MessageUtil {
    ...
    COMMAND_ADDOPENER("", "§6Crates can now be opened with the block.", "§6Mit dem Block können nun Crates geöffnet werden.", "§aEl bloque ahora se puede utilizar para abrir cajas."),
    COMMAND_REMOVEOPENER("", "§6Crates can now no longer be opened with this block.", "§6Mit diesem Block können nun keine Crates mehr geöffnet werden.", "§aLas cajas ya no se pueden abrir con este bloque."),
